...
export const GlobalSeo = () => (
  <Helmet>
    ...
    <meta name="application-name" content="Tech Beetle" />
    <meta property="og:site_name" content="Tech Beetle" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Tech Beetle" />
    <meta
      property="og:description"
      content="Tech Beetle brings tech news, reviews, and how-to guides for enthusiasts and buyers."
    />
